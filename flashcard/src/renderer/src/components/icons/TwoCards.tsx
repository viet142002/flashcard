export function TwoCards({ width = 24, height = 24 }: { width?: number; height?: number }) {

    return (
        <svg fill="currentColor" height={height} width={width} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
